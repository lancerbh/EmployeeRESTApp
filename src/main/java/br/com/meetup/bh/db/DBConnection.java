...
public class DBConnection {
	...
	public static final Optional<String> DBAAS_DEFAULT_CONNECT_DESCRIPTOR = Optional
			.ofNullable(System.getenv("DBAAS_DEFAULT_CONNECT_DESCRIPTOR"));

	// Local settings
	public static final String LOCAL_USERNAME = "oracleusr";
	public static final String LOCAL_PASSWORD = "oracle";
	public static final String LOCAL_DEFAULT_CONNECT_DESCRIPTOR = "140.86.1.237:1521/ORCL.gse00000649.oraclecloud.internal";
